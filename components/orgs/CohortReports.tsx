...
import { CohortReportCard, type CohortReportRow } from "@/components/orgs/CohortReportRow";
...
// Same cap as DashboardReports.tsx, same reason — keeps the shared radar
// chart/comparison table legible.
const MAX_COMPARE = 4;

export function CohortReports({ rows }: { rows: CohortReportRow[] }) {
